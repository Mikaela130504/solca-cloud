...
function buildStructuredClinicalData(values, patient) {
  ...
  return {
    ...
    ginecoEmbarazos: aplicaGineco ? values.embarazos : "",
    ginecoPartos: aplicaGineco ? values.partos : "",
    ginecoCesareas: aplicaGineco ? values.cesareas : "",
    ginecoAbortos: aplicaGineco ? values.abortos : "",
    ginecoObservaciones: aplicaGineco ? values.ginecoObservaciones : "",
    ...
    examenGeneral: values.examenGeneral,
    examenCabezaCuello: values.cabezaCuello,
    examenTorax: values.torax,
    examenAbdomen: values.abdomen,
    examenExtremidades: values.extremidades,
    examenNeurologico: values.neurologico,
    ...
    saturacionOxigeno: values.saturacion,
  };
}
