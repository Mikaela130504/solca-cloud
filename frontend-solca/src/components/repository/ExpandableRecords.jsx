...
const LABELS = {
  ...
  ginecoEmbarazos: "Embarazos",
  ginecoPartos: "Partos",
  ginecoCesareas: "Cesáreas",
  ginecoAbortos: "Abortos",
  ginecoObservaciones: "Observaciones gineco-obstétricas",
  medicamentosActuales: "Medicamentos actuales",
  alergias: "Alergias",
  examenFisico: "Examen físico",
  examenGeneral: "Examen general",
  examenCabezaCuello: "Cabeza y cuello",
  examenTorax: "Tórax",
  examenAbdomen: "Abdomen",
  examenExtremidades: "Extremidades",
  examenNeurologico: "Neurológico",
