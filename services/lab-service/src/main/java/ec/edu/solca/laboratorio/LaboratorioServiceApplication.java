...
class RegistroController {
  ...
  @PostMapping @ResponseStatus(HttpStatus.CREATED) @PreAuthorize("hasAnyRole('ADMIN','LABORATORIO')") RegistroDto crear(@Valid @RequestBody RegistroRequest request, HttpServletRequest http) { return service.crear(request, http); }
...
class RegistroService {
  ...
  RegistroDto crear(RegistroRequest r, HttpServletRequest http) { RegistroDto dto = repo.crear(r); Auditoria.registrar(repo.jdbc(), "CREAR_LABORATORIO", dto.idPacienteRegional(), http); return dto; }
  RegistroDto editar(Long id, RegistroRequest r, HttpServletRequest http) { RegistroDto dto = repo.editar(id, r); Auditoria.registrar(repo.jdbc(), "EDITAR_LABORATORIO", dto.idPacienteRegional(), http); return dto; }
