...
class RegistroService {
  ...
  RegistroDto crear(RegistroRequest r, HttpServletRequest http) { RegistroDto dto = repo.crear(r); Auditoria.registrar(repo.jdbc(), "CREAR_CONSULTA", dto.idPacienteRegional(), http); return dto; }
  RegistroDto editar(Long id, RegistroRequest r, HttpServletRequest http) { RegistroDto dto = repo.editar(id, r); Auditoria.registrar(repo.jdbc(), "EDITAR_CONSULTA", dto.idPacienteRegional(), http); return dto; }
