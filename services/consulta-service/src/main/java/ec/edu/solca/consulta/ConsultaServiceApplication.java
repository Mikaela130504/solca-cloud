...
class RegistroController {
  ...
  @GetMapping @PreAuthorize("hasAnyRole('ADMIN','MEDICO','LABORATORIO','IMAGENOLOGIA','REPOSITORIO')") List<RegistroDto> listar() { return service.listar(); }
  @GetMapping("/{id}") @PreAuthorize("hasAnyRole('ADMIN','MEDICO','LABORATORIO','IMAGENOLOGIA','REPOSITORIO')") RegistroDto obtener(@PathVariable("id") Long id) { return service.obtener(id); }
  @GetMapping("/paciente/{idPacienteRegional}") @PreAuthorize("hasAnyRole('ADMIN','MEDICO','LABORATORIO','IMAGENOLOGIA','REPOSITORIO')") List<RegistroDto> porPaciente(@PathVariable("idPacienteRegional") String idPacienteRegional) { return service.porPaciente(idPacienteRegional); }
