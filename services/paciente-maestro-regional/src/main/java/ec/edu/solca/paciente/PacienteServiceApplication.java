...
class PacienteController {
  ...
  @GetMapping @PreAuthorize("hasAnyRole('ADMIN','MEDICO','LABORATORIO','IMAGENOLOGIA')") List<PacienteDto> listar(@RequestParam(defaultValue="") String q) { return service.listar(q); }
  ...
  @GetMapping("/cedula/{cedula}") @PreAuthorize("hasAnyRole('ADMIN','MEDICO','LABORATORIO','IMAGENOLOGIA')") PacienteDto porCedula(@PathVariable("cedula") String cedula) { return service.porCedula(cedula); }
  @GetMapping("/{id}") @PreAuthorize("hasAnyRole('ADMIN','MEDICO','LABORATORIO','IMAGENOLOGIA')") PacienteDto porId(@PathVariable("id") String id) { return service.porId(id); }
